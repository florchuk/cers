package ua.nazarii.cers;

import com.fasterxml.jackson.databind.ObjectMapper;
import org.apache.logging.log4j.Logger;
import ua.nazarii.cers.dto.RateDto;
import ua.nazarii.cers.scrapers.Scraper;
import ua.nazarii.cers.utils.Config;
import ua.nazarii.cers.utils.ScraperClassReader;
...
public class Application {
    ...
    public static void run(Logger logger) throws Exception {
        ...
        Queue<Class<? extends Scraper>> scraperClasses =
                ScraperClassReader
                        .getClasses(Config.getProperty("CERS_CLASS_NAMES", "").split(","));
        ...
        try (
            ...
            httpRequestBuilder
                    .uri(new URI(Config.getProperty("CERS_API_URL")))
                    ...
                    .headers(
                            ...
                            "Basic " + Base64.getEncoder().encodeToString(
                                    String.format(
                                            "%s:%s",
                                            Config.getProperty("CERS_API_USERNAME"),
                                            Config.getProperty("CERS_API_PASSWORD")
                                    ).getBytes()
                            )
                    );
